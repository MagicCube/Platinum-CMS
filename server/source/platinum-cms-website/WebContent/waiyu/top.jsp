...
<div id="main">
  <!--头部开始-->
  <div id="header">
    <div id="logo_pic"><img src="/static/faculty/images/waiyu.png" style="padding:25px 0 0 470px;"></div>
    <div id = "link_search">
			<div id = "text">
  ...
  <!--头部结束-->
   ...
   <div id="side">
    <ul id="xibu_link">
      <li class="xibu"><img src="/static/faculty/images/WaiYu_nav_link_first.png" width="4" height="7" />
        <a href="/WaiYu/">
          首页
        </a>
      </li>
      <li class="xibu"><img src="/static/faculty/images/WaiYu_nav_link.png" width="4" height="7" />
