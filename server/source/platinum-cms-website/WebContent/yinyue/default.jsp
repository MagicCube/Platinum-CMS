	...
	<div id="r_content">
			...
			<div id="box">
			 ...
			 <div class="block_home_slider" >
                    		<div id="home_slider" class="flexslider">
                            	<cms:PhotoSlide id="tsztList" cssClass="slides" subcategoryId="sc000000000000000000000000000129" displayPhoto="true" count="4" />
                            </div>                       
             </div>
		...
		<div id="am">
			...
			<cms:PostList id="detail" cssClass="detail"
				subcategoryId="sc000000000000000000000000000129" count="5"></cms:PostList>
