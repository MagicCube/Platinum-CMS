...
<body>
	...
	<div id="r_content">
			...
			<!-- begin of block_home_slider -->
			 <div class="block_home_slider" >
                    		<div id="home_slider" class="flexslider">
                            	<cms:PhotoSlide id="tsztList" cssClass="slides" subcategoryId="sc000000000000000000000000000060" displayPhoto="true" count="4" />
                            </div>                       
             </div>
		...
		<div id="am">
			...
			<cms:PostList id="detail" cssClass="detail"
				subcategoryId="sc000000000000000000000000000060" count="5"></cms:PostList>
			<div id="moer_list" class="list_more">
				<a href="/gongxue/sc000000000000000000000000000060/more/">更多...</a>
			</div>
		</div>
		...
		<div id="new">
			...
			<cms:PostList id="detail" cssClass="detail"
				subcategoryId="sc000000000000000000000000000061" count="6"></cms:PostList>
			<div id="moer_list" class="list_more">
				<a href="/gongxue/sc000000000000000000000000000061/more/">更多...</a>
			</div>
		</div>
		<!--新闻结束-->
		<!--就业开始-->
		<div id="job">
			...
			<cms:PostList id="detail" cssClass="detail"
				subcategoryId="sc000000000000000000000000000062" count="6"></cms:PostList>
			<div id="moer_list" class="list_more">
				<a href="/gongxue/sc000000000000000000000000000062/more/">更多...</a>
			</div>
		</div>
	...
	<cms:Footer path="gongxue"></cms:Footer>
