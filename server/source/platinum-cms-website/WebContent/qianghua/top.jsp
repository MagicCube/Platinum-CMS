<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<link rel="stylesheet" href="/static/faculty/css/qianghua.css" type="text/css" />   
  ...
  <!--头部结束-->
   ...
   <div id="side">
    <ul id="xibu_link">
      ...
      <li class="xibu"><img src="/static/faculty/images/QiangHua_nav_link.png" width="4" height="7" />
