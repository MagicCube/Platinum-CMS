...
<body>
    ...
    <div id = "maincontent" style = "height: 660px; background: none;">
    	...
    	<cms:viewPostList id="album" subcategoryId="sc000000000000000000000000000003"  displayPhoto="true"   categoryId="<%= categoryId%>" displayDate="true" pageIndex='<%= Integer.parseInt(request.getParameter("pageIndex")) - 1%>' pageSize="9"/>
