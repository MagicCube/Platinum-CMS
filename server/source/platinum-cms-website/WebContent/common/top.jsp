...
<div id="header">
			...
			<div id="headerRight">
					...
					<div id="fastlink">
						<span><a href="/">首页</a>|<span><a href="/wap/mobile.html">移动版</a>|<a href="/introduce/ff8081813be4798a013be484d5540002.html">About NNUZC</a>|<a href="http://www.njnu.edu.cn/" target="_blank">南京师范大学</a></span>
					</div>
			</div>
</div>
...
<menu id="homemenu">		
	    ...
	    <li><a target="_blank">学生工作</a>
	        <ul id="downlist" num="2">
	            <li><a href="http://zbzs.njnu.edu.cn/stud/index.asp" target="_blank">学 工 处</a></li>
	            <li><a href="#" >团&nbsp;&nbsp;&nbsp;&nbsp;委</a></li> 
	    ...
	    <li><a>技术支持</a>
	    	<ul id="downlist" num="1">
	    		...
	    		<li><a href="#" target="_blank">现代教育技术中心</a></li> 
