...
<link href = "/static/common/css/common1.css" rel = "stylesheet"></link>
...
<div id="layer1">
<div id="header">
			<span style="float: left; margin-top: 18px; display: block;"><a href="/default1.jsp"><img src="/static/common/images/logo.png" title="首页" alt=""/></a></span>
			<div id="dynamic">
