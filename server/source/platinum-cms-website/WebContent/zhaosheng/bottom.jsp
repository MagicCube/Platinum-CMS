<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div id = "footer">
        ...
        <div id = "bottom2">
    		...
    		<div style="float:right;position:absolute;bottom:0;right:2px;"><a target="_blank" style="color:#CCC;font-size:13px;" href="http://zbzs.njnu.edu.cn/enrol/index.asp">返回旧版</a></div>
    		<!-- <div id="developer">	 
    			<ul>
