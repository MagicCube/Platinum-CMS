...
<link rel="stylesheet" type="text/css" href="/lgqhb/css/normal.css"/>
<link rel="stylesheet" type="text/css" href="/lgqhb/css/index.css"/>
<link rel="stylesheet" type="text/css" href="/lgqhb/css/introduce.css"/>
<div id="all">
	<div id="header">
    	<img class="block floatLeft" src="/lgqhb/images/main_03up.png">
    ...
    <div id="introduceContent">
    	<div id="inCttLeft" class="floatLeft">
        	<div id="albumLeft" class="floatLeft">
        	</div>
