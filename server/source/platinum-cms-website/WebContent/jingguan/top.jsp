<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<link rel="stylesheet" href="/static/faculty/css/jingguan.css" type="text/css" />   
...
<div id="main">
  <!--头部开始-->
  <div id="header">
    <div id="logo_pic"><img src="/static/faculty/images/jingguan.png" style="padding:25px 0 0 470px;"></div>
    <div id = "link_search">
			<div id = "text">
  ...
  <!--头部结束-->
   ...
   <div id="side">
    <ul id="xibu_link">
      ...
      <li class="xibu"><img src="/static/faculty/images/JingGuan_nav_link.png" width="4" height="7" />
