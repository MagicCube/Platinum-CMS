    ...
    <div id="indexContent" class="container_16">
    	<div class="grid_4" id="upLeft">
            ...
            <div id="jgHome">
            	...
            	<form accept-charset="GB2312" name="Login" action="http://zbvip.njnu.edu.cn/vip/Admin_ChkLogin.asp" method="post" target="_parent" onsubmit="document.charset='GB2312';submit();">	
            	<ul id="jgContent">
