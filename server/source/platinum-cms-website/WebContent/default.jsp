...
<body onload="onload()" onkeydown ="Tab()">
    ...
    <!-- <div class="zhaoshenglink" style="width:102px;height:270px;position:fixed;_position:absolute;z-index:10000;top:150px;right:15px;padding:1px;border:1px solid #FFF;">
