function C_slider(frame,list,Lframe,Llist,forwardEle,backEle,scrollType,LscrollType,acitonType,autoInterval){
 ...
 this.slideLength = $("#"+this.frame+"  li").length;//总的slider数量
 this.currentSlide = 0;
...
C_slider.prototype.go = function(index){
 ...
 $("#"+this.Llist+" > li").removeClass("cur1");
 $("#"+this.Llist+" > li").eq(index).addClass("cur1");
...
//实例化对象 
var goSlide = new C_slider("big_frame","big_list","small_frame","small_list","forward","back","left","left","click",5000);