<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<link rel="stylesheet" href="/static/faculty/css/gongguan.css" type="text/css" />   
...
<div id="main">
  <!--头部开始-->
  <div id="header">
    <div id="logo_pic"><img src="/static/faculty/images/gongguan.png" style="padding:25px 0 0 470px;"></div>
    <div id = "link_search">
			<div id = "text">
  ...
  <!--头部结束-->
   ...
   <div id="side">
    <ul id="xibu_link">
      <li class="xibu"><img src="/static/faculty/images/GongGuan_nav_link_first.png" width="4" height="7" />
        <a href="/gongguan/">
          首页
        </a>
      </li>
