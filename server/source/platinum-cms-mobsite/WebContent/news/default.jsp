...
<body>  
  ...
  <div class="info">
    <h3>专题报导<span id = "position_2" class="right"><a href = "/news/more/">更多...</a></span></h3>
    <div class="r_b"> 
<p>
  ...
  <div class="info">
   <h3>新闻动态<span id = "position_2" class="right"><a href = "/news/more/">更多...</a></span></h3>
   <cms:PostList id="xwdtList2" subcategoryId="sc000000000000000000000000000006" where="photoURL is null" count="8" /> 
    
    
  </div>
  <div class="info">
   <h3>校园动态<span id = "position_2" class="right"><a href = "/news/more/">更多...</a></span></h3>
